...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private String pathUri = "/board/**";
    private String title = "Board API";
    private String description = "Swagger Test";
    private String basePackage = "com.practice.board.controller";
